...
if __name__ == "__main__":
    ...
    parser.add_argument('--end_iter', type=int, default=9)
    ...
    parser.add_argument('--im_size', type=int, default=2048)
    ...
    net_ig = Generator( ngf=64, nz=noise_dim, nc=1, im_size=args.im_size)#, big=args.big )
    net_ig.to(device)

    for epoch in [args.multiplier*i for i in range(args.start_iter, args.end_iter+1)]:
        ckpt = f"{args.artifacts}/{epoch}.pth"
