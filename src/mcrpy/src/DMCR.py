...
from src import loss_computation
from src import profile
from src.Microstructure import Microstructure
from src.MutableMicrostructure import MutableMicrostructure
from src.Symmetry import Symmetry
from descriptors.OrientationDescriptor import OrientationDescriptor
from descriptors.MultiPhaseDescriptor import MultiPhaseDescriptor
...
class DMCR:
    def __init__(self,
        ...
        loader.load_plugins([f'losses.{loss_type}'])
        loader.load_plugins([f'optimizers.{optimizer_type}'])
